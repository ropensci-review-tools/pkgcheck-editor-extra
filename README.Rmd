...
<!-- badges: start -->
[![R build status](https://github.com/ropensci-review-tools/pkgcheck-editor-extra/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ropensci-review-tools/pkgcheck-editor-extra/actions?query=workflow%3AR-CMD-check.yaml)
